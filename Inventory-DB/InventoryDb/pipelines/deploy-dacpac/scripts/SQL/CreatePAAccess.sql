...
BEGIN
    THROW 50001, 'User Doesnt exist, make sure to create User first', 1;
END
...
BEGIN TRY
    ...
    ELSE 
    BEGIN
        PRINT '$(USER_LOGIN) already is dbcreator'
    END
    ...
    ELSE 
    BEGIN
        PRINT '$(USER_LOGIN) already is dbowner'
    END
    ...
    ELSE 
    BEGIN
        PRINT '$(USER_LOGIN) already is db_backupoperator'
    END
